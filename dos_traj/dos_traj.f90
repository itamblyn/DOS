...
do i=1, (nsteps - skip)/(stride + 1)
    ...
    write(2,*) "H"
    write(2,*) "   ", alat
    write(2,*) "    1.0000000000000000    0.0000000000000000    0.0000000000000000"
    write(2,*) "    0.0000000000000000    1.0000000000000000    0.0000000000000000"
    write(2,*) "    0.0000000000000000    0.0000000000000000    1.0000000000000000"
    write(2,*) natom
    write(2,*) "Direct"
    ...
    do j=1,natom
        ...
        do k=1,3
            snapshot(j,k) = snapshot(j,k)/alat
        end do
